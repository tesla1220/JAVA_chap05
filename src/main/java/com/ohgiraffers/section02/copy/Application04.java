...
//            값을 더한 것 같은데 증가되고 있지 않다. 인덱스에 접근해서 값을 변경한 게 아니고 꺼낸 값을 복사해서 쓴 것.
        ...
        /* 필기
        *   주의: 향상된 for문은 배열 내 인덱스에 차례로 접근할 때는 편하게 사용할 수 있지만, 값을 변경할 수 없다.
        *           대신, 값을 변경하는 것이 아니고 사용하는 것이 목적이라면 조금 더 편하게 사용할 수 있다. */
